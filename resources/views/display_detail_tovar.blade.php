...
<body>
    ...
    <main>
        ...
        <div class="contetn-tovar" style="gap:2rem;">
            <form action="{{ route('add_card') }}" method="post">
                @csrf
                <input type="hidden" name="name" value="{{ $tovar->name }}">
                <input type="hidden" name="category" value="{{ $tovar->category }}">
                <input type="hidden" name="slug" value="{{ $tovar->slug }}">
                ...
                <div class="block-head-tovar d-flex justify-content-between">
                    <div class="block-tovar-image col-4">
                        <img src="{{ $tovar->image }}" alt="{{ $tovar->image }}">
                    </div>
                    <div class="block-tovar-content col-7">
                        <div class="card-body pt-2 p-3">
                            <h5 class="card-title font-weight-bold">{{ $tovar->name }}</h5>
                            <p class="card-price h5 font-weight-bold">{{ $tovar->price }}Р</p>

                            <button type="submit"
                                class="button-add-card btn btn-success text-white border border-dark mt-3" btn-lg
                                btn-block">В
                                корзину</button>
                        </div>
                    </div>
        ...
        <div class="conteiner">
            <div class="block-tovar-description">
                <p class="card-text h6 text-dark font-weight-bold pt-3 pl-2">{{ $tovar->description }}</p>
            </div>
        </div>
